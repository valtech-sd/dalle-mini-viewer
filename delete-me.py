                      ...
                      if args.steps_per_checkpoint is not None:
                        if j % args.steps_per_checkpoint == 0 and j > 0:
                          if args.intermediates_in_subfolder is True:
                            print('saved1')
                            image.save(f'{partialFolder}/wwwwwww.png')
                          else:
                            print('saved2')

                            image.save(f'{batchFolder}/afdsdfd.png')
                      else:
                        if j in args.intermediate_saves:
                          if args.intermediates_in_subfolder is True:
                            print('saved3')
                            image.save(f'{partialFolder}/aaaa.png')
                          else:
                            print('saved4')
                            image.save(f'{batchFolder}/bbbb.png')
                      if cur_t == -1:
                        if frame_num == 0:
                          save_settings()
                        if args.animation_mode != "None":
                          image.save('prevFrame.png')
                        image.save(f'{batchFolder}/cccc.png')
                        buffered = BytesIO()
                        ...
                        if args.animation_mode == "3D":
                          ...
                          if turbo_mode and frame_num > 0:
                            ...
                            print('saved5')
                            image.save(f'{batchFolder}/qqqqqq.png')
